function RussiaAstrakham(id, renderer, parent){
	...
	this.add_object(new FurCommodity());
	this.add_object(new CityCommodityPrices());
	
	this.add_object(new TestMusic());
}
RussiaAstrakham.prototype = new Scene(0);