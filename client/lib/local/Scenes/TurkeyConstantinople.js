function TurkeyConstantinople(id, renderer, parent){
	...
	this.add_object(new PotteryCommodity());
	this.add_object(new CityCommodityPrices());
	
	this.add_object(new TestMusic());
}
TurkeyConstantinople.prototype = new Scene(0);